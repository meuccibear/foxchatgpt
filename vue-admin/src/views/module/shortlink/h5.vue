<template>
  <div class="app-container">
    <div class="toolbar">
      <el-button type="primary" icon="el-icon-plus" size="mini" @click="clickCreate()">普通h5转短链</el-button>
    </div>
    <el-table
      :data="dataList"
      ...
      >
        <el-form ref="form" :model="form" :rules="rules" label-width="120px">
          <el-form-item label="h5链接" prop="h5link">
            <el-input v-model="form.h5link" type="textarea" :rows="3" placeholder="请输入h5链接" size="small" style="width: 300px;" />
          </el-form-item>
